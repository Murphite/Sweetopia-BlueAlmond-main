      ...
      <>
          ...
          {!isLoading && (
              <div className="table px-5">
                  ...
                  <div className="px-2" style={{ background: "#FFBF00", border: "18px solid #FF4433", borderRadius: "10px" }}>
                      ...
                      {orderData.map((orderItem: orderHeaderModel) =>
                      {
                        const badgeColor = getStatusColor(orderItem.status!)
                          return (
                              <div className="row" key={orderItem.orderHeaderId}>
                                  ...
                                  <div className="col-1">NGN {orderItem.orderTotal!.toFixed(2)}</div>
