...
const MenuItemUpsert = () =>
{
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) =>
    {
        ...
        if (file)
        {
            ...
            const validImgTypes = ["jpeg", "jpg", "png", "svg", "webp"];
            ...
            {
                setImageToStore("");
                toastNotify("File must be less than 50 MB", "error");
                return;
            } 
            ...
            {
                setImageToStore("")
                toastNotify("File must be in jpeg, jpg, png, svg or webp format", "error")
                return;
            }
